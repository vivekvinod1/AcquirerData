    ...
    <div className="space-y-6">
      ...
      {selectedFiles.length > 0 && !uploadedFiles.length && (
        <div className="bg-white rounded-lg shadow-sm border border-visa-gray-200 p-4">
          <h3 className="font-semibold text-visa-navy mb-3">Selected Files</h3>
          <ul className="space-y-2">
            {selectedFiles.map((file, i) => (
              <li key={i} className="flex items-center justify-between p-2 bg-visa-gray-50 rounded">
                ...
                <button onClick={() => removeFile(i)} className="text-visa-red text-sm hover:underline">Remove</button>
              </li>
            ))}
          </ul>
          <button
      ...
      {uploadedFiles.length > 0 && (
        <div className="bg-white rounded-lg shadow-sm border border-visa-gray-200 p-4">
          <h3 className="font-semibold text-visa-green mb-3">Files Uploaded Successfully</h3>
